...
<body>
    <header>
        <a href="${pageContext.request.contextPath}/movieapp/home" class="logo">
            <img src="https://t4.ftcdn.net/jpg/05/00/61/19/360_F_500611919_5wuf1qGRCubiXXxIa7og1fLLCyHi6qP9.jpg" 
                 alt="Movielogo" style="height: 50px; vertical-align: middle;">
        </a>
        <div class="nav-links">
            <input type="text" placeholder="Search Movie" id="search-bar-movie">
            <input type="text" placeholder="Search Theatre" id="search-bar-theatre">
        ...
        <%
            ...
            if (movieList != null && !movieList.isEmpty()) {
                for (MovieEntity movie : movieList) {
                    String imageUrl = (movie.getMovieUrl() != null && !movie.getMovieUrl().isEmpty()) 
                                      ? movie.getMovieUrl() 
                                      : "https://via.placeholder.com/200";
        %>
        <div class="movie-container" onclick="GoToMovieInfo(<%= movie.getId() %>)">
            <div class="box">
                <img src="<%= imageUrl %>" alt="<%= movie.getTitle() %>" height="240px">
            </div>
