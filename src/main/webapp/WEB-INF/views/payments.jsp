...
<body>
    <header>
        ...
        <img src=""https://t4.ftcdn.net/jpg/05/00/61/19/360_F_500611919_5wuf1qGRCubiXXxIa7og1fLLCyHi6qP9.jpg"" alt="Movielogo" style="height: 50px; vertical-align: middle;">
        </a>
         <div class="nav-links">
    ...
    <script>
        function handlePayment(totalPrice) {
            ...
            window.location.href = '/movietapp/payments/confirm/' + totalPrice;
        }
