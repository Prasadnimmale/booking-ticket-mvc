<%@ page import="com.example.movieticket.entity.TheatreEntity, java.util.List, com.example.movieticket.entity.ShowtimeEntity, com.example.movieticket.entity.MovieEntity" %>
...
<body>
    <header>
        <a href="${pageContext.request.contextPath}/movieapp/home" class="logo">
            <img src="https://as2.ftcdn.net/v2/jpg/01/68/46/15/1000_F_168461551_pyiS0OjsgzoEvZly7VXBoULmoHxoquCW.jpg" 
                 alt="MovieSpace" style="height: 50px; vertical-align: middle;">
        </a>
        <div class="nav-links">
    ...
    <main class="main-container">
        <%
            ...
            MovieEntity movieInfo = (MovieEntity) request.getAttribute("movieInfo"); 
        ...
        <div class="content-container">
            <div class="left-section">
                <div class="box">
                    <% if (movieInfo != null) { %>
                        <img class="movie-image" src="<%= movieInfo.getMovieUrl() != null ? movieInfo.getMovieUrl() : "https://via.placeholder.com/200" %>" 
                             alt="<%= movieInfo.getTitle() %>">
                        <h3><strong>Theatre:</strong> <%= selectedTheatre != null ? selectedTheatre.getName() : "N/A" %></h3>       
                    ...
                    <% } else { %>
                        <p class="error-message">Movie information is unavailable.</p>
                    <% } %>
                </div>
            </div>
        ...
        <div class="buttons-container">
            ...
            <% } else { %>
                <p class="error-message">Theatre details are missing.</p>
            <% } %>
    ...
    <script>
        ...
        function GotoSeatSelection(theatreId) {
            ...
            window.location.href = "/movieapp/seat-selection-movie/" 
        ...
        function searchStuff() {
            ...
            if (movieTerm && theatreTerm) {
                ...
                window.location.href = '/movieapp/search/' + encodeURIComponent(movieTerm);
            } else if (theatreTerm) {
                window.location.href = '/movieapp/search-theatre/' + encodeURIComponent(theatreTerm);
            } else {
